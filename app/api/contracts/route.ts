    ...
    if (id) {
      ...
      sql = `
        SELECT CONTRACT_ID, CONTRACT_TITLE, CUSTOMER_NAME, CONTRACT_DATE, EXPIRY_DATE,
               ...
               CASE WHEN PDF_STAGE_PATH IS NOT NULL AND PDF_STAGE_PATH != ''
                 THEN GET_PRESIGNED_URL(@CUSTOMER_360.PUBLIC.CONTRACT_DOCUMENTS_STAGE,
                   REPLACE(PDF_STAGE_PATH, '@CUSTOMER_360.PUBLIC.CONTRACT_DOCUMENTS_STAGE/', ''))
